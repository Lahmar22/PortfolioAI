    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-900 text-slate-200 px-4 py-12">
      ...
      <div className="relative z-10 w-full max-w-md bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
        ...
        <p className="text-slate-400 text-center mb-8">
          Get started building your professional portfolio in minutes
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-1.5" htmlFor="register-fullname">Full Name</label>
            <input
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-1.5" htmlFor="register-email">Email</label>
            <input
              id="register-email"
              type="email"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-1.5" htmlFor="register-password">Password</label>
            <input
